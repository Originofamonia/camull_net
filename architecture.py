...
class ConvBlock(nn.Module):
    ...
    def __init__(self, c_in, c_out, ks, k_stride=1):
        ...
        self.conv1 = nn.Conv3d(c_in, c_out, ks, stride=k_stride,
                               padding=(1, 1, 1))
...
class ConvBlock2(nn.Module):
    ...
    def __init__(self, chans, ks, k_stride=1):
        ...
        # depthwise
        self.conv1 = nn.Conv3d(chans, chans, kernel_size=conv1_ks,
                               stride=k_stride, padding=(0, 1, 1), groups=chans)
        # pointwise
        self.conv2 = nn.Conv3d(chans, chans, kernel_size=conv2_ks,
                               stride=k_stride, padding=(1, 0, 0))
