...
def train_new_model_cli():
    ...
    if int(choice) == 0:
        ...
        print("A new NC vs AD model has been trained under the tag: {}".format(
            uuid))
        ...
        print(
            "To train for sMCI vs pMCI you need transfer learning from a NC "
            "vs AD model. Would you like to transfer learning from an "
            "existing model or train a new NC vs AD model?\n")
        print("0. Existing model.")
        print("1. Train a new NC vs AD model.\n")
        choice = input("Please select an option: ")
        if int(choice) == 0:
            # Display the 5 most recent models.
            model_uuids = ["as3asf34f352f43t42w90asf3e",
                           "86ft3nfa9nf302yns273nds82n",
                           "872b17sd271dn27717rsnsaf31",
                           "86ft3nfa9nf302yns273nds82n",
                           "86ft3nfa9nf302yns273nds82n"]
            print("Here are the 5 most recent models...(dummies)")
            print(
                "0. {} 01/02/20T12:02:31:03 avg. auc={}".format(model_uuids[0],
                                                                0))
            print(
                "1. {} 01/02/20T12:03:31:03 avg. auc={}".format(model_uuids[1],
                                                                0))
            print(
                "2. {} 01/02/20T12:06:20:01 avg. auc={}".format(model_uuids[2],
                                                                0))
            print(
                "3. {} 01/02/20T12:03:31:03 avg. auc={}".format(model_uuids[3],
                                                                0))
            print(
                "4. {} 01/02/20T12:03:31:03 avg. auc={}".format(model_uuids[4],
                                                                0))
            print("5. Other.")
            print("\n")
            choice = input("Please select an option: ")
            if int(choice) != 5:
                ...
                print(
                    "A new NC vs AD model has been trained under the tag: {}".format(
                        uuid))
                print("Would you like to evaluate it?")
                print("0. Yes")
                print("1. No")
            ...
            uuid = start(ld_helper, 40)
            print(
                "A new NC vs AD model has been generated under the tag: {}.".format(
                    uuid))
            print("Initiating transfer learning for the sMCI vs pMCI task.")
            ld_helper.change_task(Task.sMCI_v_pMCI)
            uuid = start(ld_helper, 40, uuid)
            print(
                "A new sMCI vs pMCI model under the tag {} has been trained.\n".format(
                    uuid))
...
def get_subject_info():
    ...
    clinical = {"AGE": float(input("What is the age of the subject?: ")),
                "GENDER": input("What is the subjects gender?: "),
                "ETHNICITY": input("What is the subjects ethnicity?: "),
                "RACCAT": input("What is the subjects race?: "),
                "PTEDUCAT": float(
                    input(
                        "How many years did the patient spent in education?: ")),
                "APOE4": float(
                    input("How many apoe4 genes does the subject have?: ")),
                "CDRSB": float(input("What is the subjects CDRSB score?: ")),
                "ADAS11": float(input("What is the subjects ADAS11 score?: ")),
                "ADAS13": float(input("What is the subjects ADAS13 score?: ")),
                "RAVLT_immediate": float(
                    input("What is the subjects RAVLT_immediate score?: ")),
                "RAVLT_learning": float(
                    input("What is the subjects RAVLT_learning score?: ")),
                "RAVLT_forgetting": float(
                    input("What is the subjects RAVLT_forgetting score?: ")),
                "RAVLT_perc_forgetting": float(
                    input(
                        "What is the subjects RAVLT percentage forgetting score?"))}
...
def make_an_inference():
    ...
    if choice == 0:
        ...
        model_uuids = ["as3asf34f352f43t42w90asf3e",
                       ...
                       "86ft3nfa9nf302yns273nds82n"]
        print(
            "Here are the 5 most recent models trained for NC vs AD...(dummies)")
        print(
            "0. {} 01/02/20T12:02:31:03 avg. auc={}".format(model_uuids[0], 0))
        print(
            "1. {} 01/02/20T12:03:31:03 avg. auc={}".format(model_uuids[1], 0))
        print(
            "2. {} 01/02/20T12:06:20:01 avg. auc={}".format(model_uuids[2], 0))
        print(
            "3. {} 01/02/20T12:03:31:03 avg. auc={}".format(model_uuids[3], 0))
        print(
            "4. {} 01/02/20T12:03:31:03 avg. auc={}".format(model_uuids[4], 0))
        print("5. Other.")
        print("\n")
        choice = input("Please select an option: ")
        ...
        if (int(choice) != 5):
            ...
            with torch.no_grad():
                net_out = model(
                    (mri_t.view(-1, 1, 110, 110, 110), clin_t.view(1, 21)))
...
def basic_run():
    """The basic run doesn't give the user option to tweak the
    hyper-parameters. """
